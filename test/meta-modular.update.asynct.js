  ...
  exports ['can clear added objects'] = function (test){
    var mm = MetaModular()
      ...
      function cleared(){    
        console.log('cleared')
        console.log(mm.tests.get(tests.natural.test))
...
/****/
  exports ['addTest addCandidate then update, to run test!'] = function (test){
    ...
    mm.update_pair(tests.natural.test,candidates.natural2,isCalled(updated2_1))
...
/****/
  exports ['addTest addCandidate then update, to run test, with a failing test!'] = function (test){
    ...
    mm.update_pair(tests.naturalRandom.test,candidates.natural2,isCalled(updated2_2))
